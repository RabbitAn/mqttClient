...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 139, ; uint32_t number_of_assemblies_in_apk (0x8b)
	i32 0, ; uint32_t bundled_assembly_name_width (0x0)
	i32 2, ; uint32_t number_of_assembly_store_files (0x2)
	i32 654, ; uint32_t number_of_dso_cache_entries (0x28e)
	i32 33555182, ; uint32_t android_runtime_jnienv_class_token (0x20002ee)
	i32 100671127, ; uint32_t jnienv_initialize_method_token (0x6001e97)
	i32 100671126, ; uint32_t jnienv_registerjninatives_method_token (0x6001e96)
...
; DSO cache entries
@dso_cache = dso_local local_unnamed_addr global [654 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.87_name, ; name: libaot-System.Net.WebSockets.Client.dll.so
		ptr null; void* handle (0x0)
	}, ; 1
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 388427716926447920, ; hash 0x563f8f358512130, from name: aot-MQTTnet.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.25_name, ; name: libaot-MQTTnet.dll.so
		ptr null; void* handle (0x0)
	}, ; 16
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.56_name, ; name: libaot-Xamarin.GooglePlayServices.Location.dll.so
		ptr null; void* handle (0x0)
	}, ; 19
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.88_name, ; name: libaot-System.Net.WebSockets.dll.so
		ptr null; void* handle (0x0)
	}, ; 25
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.86_name, ; name: libaot-System.Net.WebProxy.dll.so
		ptr null; void* handle (0x0)
	}, ; 59
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.98_name, ; name: libaot-System.Text.Encodings.Web.dll.so
		ptr null; void* handle (0x0)
	}, ; 79
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.50_name, ; name: libaot-Xamarin.AndroidX.VersionedParcelable.dll.so
		ptr null; void* handle (0x0)
	}, ; 129
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.85_name, ; name: libaot-System.Net.WebHeaderCollection.dll.so
		ptr null; void* handle (0x0)
	}, ; 150
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 5986788099116322429, ; hash 0x5315580e895d4e7d, from name: libaot-MQTTnet.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.25_name, ; name: libaot-MQTTnet.dll.so
		ptr null; void* handle (0x0)
	}, ; 200
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.99_name, ; name: libaot-System.Text.Json.dll.so
		ptr null; void* handle (0x0)
	}, ; 261
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 8408425347822646438, ; hash 0x74b0ba4dd95bf4a6, from name: MQTTnet
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.25_name, ; name: libaot-MQTTnet.dll.so
		ptr null; void* handle (0x0)
	}, ; 287
	...
	%struct.DSOCacheEntry {
		i64 12589471003088303627, ; hash 0xaeb6c92ce928b60b, from name: MQTTnet.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.25_name, ; name: libaot-MQTTnet.dll.so
		ptr null; void* handle (0x0)
	}, ; 448
	...
	%struct.DSOCacheEntry {
		i64 14324324037375107137, ; hash 0xc6ca38d187552041, from name: libaot-MQTTnet
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.25_name, ; name: libaot-MQTTnet.dll.so
		ptr null; void* handle (0x0)
	}, ; 509
	...
	%struct.DSOCacheEntry {
		i64 17445254100750870766, ; hash 0xf219fe2cfbaea8ee, from name: aot-MQTTnet
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.25_name, ; name: libaot-MQTTnet.dll.so
		ptr null; void* handle (0x0)
	}, ; 615
...
@.env.3 = private unnamed_addr constant [37 x i8] c"0c30dfee-5f7f-4dc8-9798-ae1e65dd5a0e\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [16 x i8] c"com.MqttMessage\00", align 16
...
@.DSOCacheEntry.25_name = private unnamed_addr constant [22 x i8] c"libaot-MQTTnet.dll.so\00", align 16
...
@.DSOCacheEntry.50_name = private unnamed_addr constant [51 x i8] c"libaot-Xamarin.AndroidX.VersionedParcelable.dll.so\00", align 16
...
@.DSOCacheEntry.56_name = private unnamed_addr constant [50 x i8] c"libaot-Xamarin.GooglePlayServices.Location.dll.so\00", align 16
...
@.DSOCacheEntry.85_name = private unnamed_addr constant [45 x i8] c"libaot-System.Net.WebHeaderCollection.dll.so\00", align 16
@.DSOCacheEntry.86_name = private unnamed_addr constant [34 x i8] c"libaot-System.Net.WebProxy.dll.so\00", align 16
@.DSOCacheEntry.87_name = private unnamed_addr constant [43 x i8] c"libaot-System.Net.WebSockets.Client.dll.so\00", align 16
@.DSOCacheEntry.88_name = private unnamed_addr constant [36 x i8] c"libaot-System.Net.WebSockets.dll.so\00", align 16
...
@.DSOCacheEntry.98_name = private unnamed_addr constant [40 x i8] c"libaot-System.Text.Encodings.Web.dll.so\00", align 16
@.DSOCacheEntry.99_name = private unnamed_addr constant [31 x i8] c"libaot-System.Text.Json.dll.so\00", align 16
...
@.DSOCacheEntry.107_name = private unnamed_addr constant [27 x i8] c"libaot-Java.Interop.dll.so\00", align 16
@.DSOCacheEntry.108_name = private unnamed_addr constant [35 x i8] c"libaot-Mono.Android.Runtime.dll.so\00", align 16
@.DSOCacheEntry.109_name = private unnamed_addr constant [27 x i8] c"libaot-Mono.Android.dll.so\00", align 16
@.DSOCacheEntry.110_name = private unnamed_addr constant [37 x i8] c"libaot-System.Private.CoreLib.dll.so\00", align 16
